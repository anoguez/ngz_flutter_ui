...
class _YearMarkers extends StatelessWidget {
  _YearMarkers({
    super.key,
    required this.timelineStartYear,
    required this.timelineEndYear,
  });

  final int timelineStartYear;
  final int timelineEndYear;

  late final int _totalYrs = timelineEndYear - timelineStartYear;

  /// Normalizes a given year to a value from 0 - 1, based on start and end yr.
  double _calculateOffsetY(int yr) => (yr - timelineStartYear) / _totalYrs;
    ...
    return IgnorePointer(
      ...
      child: LayoutBuilder(builder: (_, constraints) {
        ...
        late final markers = List.generate(numMarkers, (i) {
          return timelineStartYear + i * interval;
        });
